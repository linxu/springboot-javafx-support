...
public abstract class AbstractFxmlView implements ApplicationContextAware {
    ...
    public void initController(Object params) {
        if (fxmlLoader.getController() instanceof ControllerInitializable) {
            ControllerInitializable controllerInitializable = fxmlLoader.getController();
            controllerInitializable.init(params);
        }
    }
}
