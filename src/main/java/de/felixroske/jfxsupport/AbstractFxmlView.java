...
public abstract class AbstractFxmlView implements ApplicationContextAware {
    ...
    public AbstractFxmlView() {
        ...
        final String filePathFromPackageName =
                PropertyReaderHelper.determineFilePathFromPackageName(getClass());
    ...
    void addCSSIfAvailable(final Parent parent) {
        ...
        final List<String> list =
                PropertyReaderHelper.get(applicationContext.getEnvironment(), "javafx.css");
        if (!list.isEmpty()) {
            list.forEach(css -> parent.getStylesheets()
    ...
    public String toString() {
        return "AbstractFxmlView [presenterProperty=" + presenterProperty + ", bundle=" + bundle
